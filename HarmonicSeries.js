...
/**
 * Main loop: randomly select harmonics to fade in/out
 */
function startHarmonicLoop() {
  // Min/max duration for a harmonic to stay active
  ...
  const loop = () => {
    ...
    const interval = 4 + Math.random() * 6; // 4-10 seconds between new notes
